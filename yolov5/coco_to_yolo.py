...
class ConvertCOCOToYOLO:
    ...
    def __init__(self, img_folder, json_path):
        ...
        self.save_path = 'detection/dataset/yolo_dataset/labels/train'
    ...
    def convert(self,annotation_key='annotations',img_id='image_id',cat_id='category_id',bbox='bbox'):
        ...
        for i in range(len(data[annotation_key])):
            ...
            if not self.save_path in filename:
...
if __name__ == "__main__":
    ConvertCOCOToYOLO(img_folder='detection/dataset/train', json_path='detection/dataset/train.json').convert()
