...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='MlflowLoggerHook', exp_name='0406_atss_albu_full')
    ])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/0406_atss_swin_l_fpn_full/epoch_12.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/0406_atss_swin_l_fpn_full'
auto_resume = False
gpu_ids = [0]
