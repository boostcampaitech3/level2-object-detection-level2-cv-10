...
checkpoint_config = dict(max_keep_ckpts=7, interval=1)
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook')])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/0401_cascade_rcnn_swin_l_fpn_full/epoch_18.pth'
workflow = [('train', 1)]
opencv_num_threads = 0
mp_start_method = 'fork'
work_dir = './work_dirs/0401_cascade_rcnn_swin_l_fpn_full'
auto_resume = False
gpu_ids = [0]
