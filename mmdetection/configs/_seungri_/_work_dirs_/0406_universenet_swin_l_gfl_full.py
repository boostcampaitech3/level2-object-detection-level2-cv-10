...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='MlflowLoggerHook', exp_name='0406_universenet_full')
    ])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/0406_universenet_swin_l_gfl_full/epoch_11.pth'
workflow = [('train', 1)]
opencv_num_threads = 0
mp_start_method = 'fork'
work_dir = './work_dirs/0406_universenet_swin_l_gfl_full'
auto_resume = False
gpu_ids = [0]
