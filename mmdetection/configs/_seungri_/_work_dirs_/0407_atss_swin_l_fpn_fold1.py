...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/opt/ml/detection/dataset/train1.json',
    ...
    val=dict(
        ...
        classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                 'Plastic', 'Styrofoam', 'Plastic bag', 'Battery', 'Clothing'),
        ann_file='/opt/ml/detection/dataset/val1.json',
        img_prefix='/opt/ml/detection/dataset/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='MlflowLoggerHook', exp_name='0407_atss_albu_fold1')
    ])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/0407_atss_swin_l_fpn_fold1/epoch_4.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/0407_atss_swin_l_fpn_fold1'
auto_resume = False
gpu_ids = [0]
